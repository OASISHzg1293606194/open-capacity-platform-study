...
CREATE DATABASE IF NOT EXISTS `ops_0` DEFAULT CHARACTER SET = utf8mb4;
Use `ops_0`;
...
#导出 user-center 的数据库结构
CREATE DATABASE IF NOT EXISTS `ops_1` DEFAULT CHARACTER SET = utf8mb4;
Use `ops_1`;
...
#导出 user-center 的数据库结构
CREATE DATABASE IF NOT EXISTS `ops_2` DEFAULT CHARACTER SET = utf8mb4;
Use `ops_2`;
